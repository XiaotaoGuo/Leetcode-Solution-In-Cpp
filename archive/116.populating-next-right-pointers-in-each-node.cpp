...
private:
    void connectLeftAndRight(Node* left, Node* right){
        if(!left) return;
        left->next = right;
        if(left->right){
            ...
            if(right && right->left){
                ...
                connectLeftAndRight(left->right, right->right);
            }
        }
        else{
            if(right && right->left){
                connectLeftAndRight(left->left, right->left);
                connectLeftAndRight(right->left, right->right);
            }
            else if(right && right->right){
                connectLeftAndRight(left->left, right->right);
            }
        }
